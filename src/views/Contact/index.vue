...
<template>
  <div class="max-w-[1440px] mx-auto">
    <div class="pt-12 px-24">
      <div class="relative">
        <p
          class="absolute ltr:left-8 rtl:right-8 top-[3px] text-2xl font-bold text-[#45315D] "
        >
    ...
    <div class="mt-60 relative mx-10">
      <img
    ...
    <div class="px-24">
      <div class="text-start">
        <p
          class="text-xl font-bold text-[#45315D] pb-2"
        >
    ...
    <div class="pt-10 px-24 pb-24">
      <div class="grid grid-cols-2 gap-10 items-center">
        <Form
          class="z-10 text-start shadow-form rounded-[10px] pt-[52px] pb-11 px-10"
          @submit=""
